      ...
      <div className="container mx-auto flex items-center justify-between h-16 px-4">
        ...
        <div className="hidden lg:flex items-center gap-3">
          <a href="tel:9980834941">
            <Button size="md" className="h-11 rounded-md px-4 text-white font-semibold flex items-center gap-2">
        ...
        <div className="lg:hidden border-t border-border bg-card px-4 pb-4">
          ...
          <div className="mt-4 flex flex-col gap-2">
            <a href="tel:9980834941" onClick={() => setMobileOpen(false)}>
              <Button className="w-full text-white font-semibold">Call Now</Button>
            </a>
          </div>
        </div>
      )}
